...
/*
        ...
        */
        ...
        result+= "<div class='container text-left' style='" + containerStyle + "'><div class='row'><div class='col'><h3 style='margin-left: 20px;'>Billing Information</h3><button class='btn btn-secondary' type='button' style='margin-right: 10px;'>Consumption History</button><button class='btn btn-secondary' type='button' style='margin-right: 10px;'>Receivables History</button><button class='btn btn-secondary' type='button'>Payment History</button></div></div></div>";
