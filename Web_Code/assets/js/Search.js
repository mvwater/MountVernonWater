...
//result = "<div class='container text-left' style='" + containerStyle + "'> <div class='row'><div class='col'> <p id='res_account_number'><b>Account Number:&nbsp;</b>" + res_accountNumber + "</p> </div></div></div>";
        ...
        //result += "<div class='container text-left' style='" + containerStyle + "0px;'><div class='row'><div class='col'><h3 style='padding: 20px;'>General Information</h3>";
...
// Add data member to AccountInfo class
        ...
        result += "</div> <div class='col-2' style='right-align'> <button id='view_comments' class='btn btn-secondary' href='#' type='button'>View Comments</button> </div></div></div>";
