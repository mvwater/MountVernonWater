...
function displayAccountInfo(resultString){
    ...
    else 
    {
      ...
      // Move style instructions to css
      result += "<div class='+container+'><div class='container text-left'style='background-color: #CCCCFF;margin-bottom: 0px;padding-bottom: 10px;padding-top: 0px;margin-top: 15px;><div class='><div class='col'><div><p><span style='text-decoration: underline;'>General Information</span></p><fieldset><label>Comments?&nbsp;</label><input type='text' id='comments' name='comments' placeholder='FALSE'><a id='openComments' href='#' style='margin-left: 10px;'>Open Comments</a></fieldset><fieldset><label for='AcctStatus'>Account Status:&nbsp;</label><input type='text' id='"+res_accountStatus+"' value='"+res_accountStatus+"' name='AcctStatus' placeholder='(A)' style='width: 30px;'></fieldset><fieldset><label for='StartDt'>Start Date:&nbsp;</label><input type='text' id='"+res_startDate+"' value='"+res_startDate+"' name='StartDt' placeholder='(08-15-2017)' style='width: 100px;'></fieldset><fieldset><label for='Name'>Name:&nbsp;</label><input type='text' id='"+res_name+"' value='"+res_name+"' name='Name' placeholder='(WATER TREATMENT PLANT)' style='width: 80%;'></fieldset><fieldset><label for='Add1'>Address 1:&nbsp;</label><input type='text' id='"+res_add1+"' value='"+res_add1+"' name='Add1' placeholder='(1550 OLD DELAWARE RD)' style='width: 70%;'></fieldset><fieldset><label for='Add2'>Address 2:&nbsp;</label><input type='text' id='"+res_add2+"'  value='"+res_add2+"'name='Add2' style='width: 70%;'></fieldset><fieldset><label for='Add3'>Address 3:&nbsp;</label><input type='text' id='"+res_add3+"' value='"+res_add3+"' name='Add3' style='width: 70%;'></fieldset><fieldset><label for='City'>City:&nbsp;</label><input type='text' id='"+res_city+"' value='"+res_city+"' name='City' placeholder='(MOUNT VERNON)' style='width: 50%;'></fieldset><fieldset><label for='State'>State:&nbsp;</label><input type='text' id='"+res_state+"' value='"+res_state+"' name='State' placeholder='(OH)' style='width: 60px;'></fieldset><fieldset><label for='Zip'>ZIP:&nbsp;</label><input type='text' id='"+res_zip+"' value='"+res_zip+"' name='Zip' placeholder='(43050)' style='width: 90px;'></fieldset><fieldset><label for='PhoneNum'>Phone Number:&nbsp;</label><input type='text' id='"+res_phoneNum+"' value='"+res_phoneNum+"' name='PhoneNum' placeholder='(330-465-0240)' style='width: 90px;'></fieldset><fieldset><label for='Email'>Email:&nbsp;</label><input type='text' id='"+res_email+"'   value='"+res_email+"' name='Email' placeholder='(canfield1@kenyon.edu)' style='width: 90px;'></fieldset><fieldset><label for='SScan'>SScan:&nbsp;</label><input type='text' id='"+res_sscan+"' value='"+res_sscan+"' name='SScan' placeholder='(????)' style='width: 90px;'></fieldset><fieldset><label for='DLnum'>DLnum:&nbsp;</label><input type='text' id='"+res_dlnum+"' value='"+res_dlnum+"' name='DLnum' placeholder='(!!!!!!)' style='width: 90px;'></fieldset><fieldset><label for='CellNum'>Cell phone number:&nbsp;</label><input type='text' id='"+res_cellNum+"'  value='"+res_cellNum+"'  name='CellNum' placeholder='(43050)' style='width: 90px;'></fieldset><fieldset><label for='DoB'>Date of Birth:&nbsp;</label><input type='text' id='"+res_dob+"'  value='"+res_dob+"' name='DoB' placeholder='(04-13-1998)' style='width: 90px;'></fieldset></div></div></div></div>";
      ...
      result += "<div class='+container+'><div class='container text-left'style='background-color: #CCCCFF;margin-bottom: 0px;padding-bottom: 10px;padding-top: 0px;margin-top: 15px;><div class='><div class='col'><div><p><span style='text-decoration: underline;'>Landlord Information</span></p><fieldset><label for='Name'>Name:&nbsp;</label><input type='text' id='"+land_name+"' value='"+land_name+"' name='Name' placeholder='(WATER TREATMENT PLANT)' style='width: 80%;'></fieldset><fieldset><label for='Add1'>Address 1:&nbsp;</label><input type='text' id='"+land_add1+"'  value='"+land_add1+"' name='Add1' placeholder='(1550 OLD DELAWARE RD)' style='width: 70%;'></fieldset><fieldset><label for='Add2'>Address 2:&nbsp;</label><input type='text' id='"+land_add2+"' value='"+land_add2+"' name='Add2' style='width: 70%;'></fieldset><fieldset><label for='Add3'>Address 3:&nbsp;</label><input type='text' id='"+land_add3+"' value='"+land_add3+"' name='Add3' style='width: 70%;'></fieldset><fieldset><label for='City'>City:&nbsp;</label><input type='text' id='"+land_city+"' value='"+land_city+"' name='City' placeholder='(MOUNT VERNON)' style='width: 50%;'></fieldset><fieldset><label for='State'>State:&nbsp;</label><input type='text' id='"+land_state+"' value='"+land_state+"' name='State' placeholder='(OH)' style='width: 60px;'></fieldset><fieldset><label for='Zip'>ZIP:&nbsp;</label><input type='text' id='"+land_zip+"' value='"+land_zip+"' name='Zip' placeholder='(43050)' style='width: 90px;'></fieldset><fieldset><label for='PhoneNum'>Phone Number:&nbsp;</label><input type='text' id='"+land_phoneNum+"' value='"+land_phoneNum+"' name='PhoneNum' placeholder='(330-465-0240)' style='width: 90px;'></fieldset><fieldset><label for='Email'>Email:&nbsp;</label><input type='text' id='"+land_email+"' value='"+land_email+"' name='Email' placeholder='(canfield1@kenyon.edu)' style='width: 90px;'></fieldset><fieldset><label for='SScan'>SScan:&nbsp;</label><input type='text' id='"+land_sscan+"' value='"+land_sscan+"' name='SScan' placeholder='(????)' style='width: 90px;'></fieldset><fieldset><label for='DLnum'>DLnum:&nbsp;</label><input type='text' id='"+land_dlnum+"' value='"+land_dlnum+"' name='DLnum' placeholder='(!!!!!!)' style='width: 90px;'></fieldset><fieldset><label for='CellNum'>Cell phone number:&nbsp;</label><input type='text' id='"+land_cellNum+"' value='"+land_cellNum+"' name='CellNum' placeholder='(43050)' style='width: 90px;'></fieldset><fieldset><label for='DoB'>Date of Birth:&nbsp;</label><input type='text' id='"+land_dob+"' value='"+land_dob+"' name='DoB' placeholder='(04-13-1998)' style='width: 90px;'></fieldset></div></div></div></div>";
